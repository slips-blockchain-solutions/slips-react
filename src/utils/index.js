...
export function formatFixed(bigNumberish, options) {
    const {
      decimalPlaces = 4,
    ...
    const bigNumber = normalizeBigNumberish(bigNumberish)
    ensureBoundedInteger(decimalPlaces, _MAX_DECIMAL_PLACES)
  
    const minimumNonZeroValue = new BigNumber(decimalPlaces === 0 ? '0.5' : `0.${'0'.repeat(decimalPlaces)}5`)
